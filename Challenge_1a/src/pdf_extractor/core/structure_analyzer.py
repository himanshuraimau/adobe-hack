...
try:
    from ..models.models import ClassificationResult, Heading, DocumentStructure
except ImportError:
    from src.pdf_extractor.models.models import ClassificationResult, Heading, DocumentStructure
